...
$(function() {
    ...
    describe('RSS Feeds', function() {
        ...
        allFeeds.forEach(function(feed) {
            it('should have defined URLs, which are not empty', function() {
         ...
         */
        allFeeds.forEach(function(feed) {
            it('should have defined names, which are not empty', function() {
    ...
    /* This test suite makes use of Jasmine-Jquery.js
    ...
    describe('New Feed Selection', function() {
        var feedOneContent, feedTwoContent;

        beforeEach(function(done) {
            loadFeed(0, function() {
                feedOneContent = $('.feed').html();
                done();
            });
        });
        ...
        it('should have different content', function(done) {
            loadFeed(1, function() {
                feedTwoContent = $('.feed').html();

                expect(feedOneContent).toBeDefined();
                expect(feedTwoContent).toBeDefined();
